...
/**
 * Az újfajta jegyzetnézegető fő fájlja
 */
public class BetterNoteViewViewerHandler implements Handler {
    ...
    public void handle(@NotNull Context ctx) throws Exception {
        ...
        final String def = Placeholder.replace(new String(Files.readAllBytes(Paths.get("html/viewing/viewer.html"))))
